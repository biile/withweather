...
import xyz.yyaxu.withweather.gson.Forecast;
import xyz.yyaxu.withweather.gson.Weather;
import xyz.yyaxu.withweather.util.HttpUtil;
import xyz.yyaxu.withweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid = " +
                weatherId + "&key = 7cd5f14335a0444591ef161b749dbf07";
